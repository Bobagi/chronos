...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    server: {
      ...
      proxy: {
        '/game': { target: chronosTarget, changeOrigin: true, secure: proxySecure },
        '/auth': { target: chronosTarget, changeOrigin: true, secure: proxySecure },
        '/friends': { target: chronosTarget, changeOrigin: true, secure: proxySecure }
      }
    },
    test: {
      projects: [
