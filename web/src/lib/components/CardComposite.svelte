...
>
	...
	<div
		...
		style="position:absolute;top:7.5cqh;right:8.5cqw;width:4.2cqh;height:3.2cqh;display:flex;align-items:center;justify-content:center;z-index:3;font-size:3.4cqh;pointer-events:none;letter-spacing:-0.12em;text-rendering:optimizeLegibility;font-kerning:normal;"
	>
		{cornerNumberValue}
	</div>
</div>
